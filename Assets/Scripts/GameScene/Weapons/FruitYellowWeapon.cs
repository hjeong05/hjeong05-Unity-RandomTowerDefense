...
public class FruitYellowWeapon : MonoBehaviour {
    ...
    void Start()
    {
        ...
        float up = bulletPrefab.GetComponent<FruitYellowBullets>().GetDamage();      // 강화시 데미지 업 
        bulletPrefab.GetComponent<FruitYellowBullets>().SetDamage(up);
    ...
    {
        bulletPrefab.GetComponent<FruitYellowBullets>().damage = bulletPrefab.GetComponent<FruitYellowBullets>().StartDamage;
    }
    void UpdateTarget()
    {
    ...
    {
        float up = bulletPrefab.GetComponent<FruitYellowBullets>().GetDamage() + 2f;
        bulletPrefab.GetComponent<FruitYellowBullets>().SetDamage(up);
    ...
    void Shoot()
    {
        ...
        FruitYellowBullets bullet = bulletSpawn1.GetComponent<FruitYellowBullets>();
