...
public class FruitGreenWeapon : MonoBehaviour {
    ...
    {
       bulletPrefab.GetComponent<FruitGreenBullets>().damage = bulletPrefab.GetComponent<FruitGreenBullets>().startDamage;
    }

    void Start()
    {
 
        float up = bulletPrefab.GetComponent<FruitGreenBullets>().GetDamage();      // 강화시 데미지 업 
        bulletPrefab.GetComponent<FruitGreenBullets>().SetDamage(up);
    ...
    {
        float up = bulletPrefab.GetComponent<FruitGreenBullets>().GetDamage() + 2f;
        bulletPrefab.GetComponent<FruitGreenBullets>().SetDamage(up);
        Debug.Log(this.gameObject.name + "초록 무기 중간에 강화 데미지: " + up);
    }
    void Update()
    {   
        if (IsDestroy == true)
    ...
    //    Debug.Log(this.gameObject.tag);
        ...
        FruitGreenBullets bullet = bulletSpawn1.GetComponent<FruitGreenBullets>();
